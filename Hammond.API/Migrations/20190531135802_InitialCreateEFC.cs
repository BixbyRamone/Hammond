...
{
    public partial class InitialCreateEFC : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfScore = table.Column<DateTime>(nullable: false),
                    StudentId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActScores_AspNetUsers_StudentId",
