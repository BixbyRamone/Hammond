...
namespace Hammond.API.Migrations
{
    ...
    [Migration("20200716152808_ChangedACTscoreToFloat")]
    partial class ChangedACTscoreToFloat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hammond.API.Models.ActScore", b =>
                {
                    ...
                    b.Property<int?>("MathmaticsScore");
            ...
            modelBuilder.Entity("Hammond.API.Models.AssignmentMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Hammond.API.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Hammond.API.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime?>("DayOfSession");
            ...
            modelBuilder.Entity("Hammond.API.Models.UserGroup", b =>
                {
                    b.Property<int>("UserId");
            ...
            modelBuilder.Entity("Hammond.API.Models.UserGroup", b =>
                {
                    b.HasOne("Hammond.API.Models.Group", "Group")
                        .WithMany("UserGroups")
